...
class RankListwiseOSLLM(RankLLM):
    ...
    def run_llm(self, prompt: str, current_window_size: Optional[int] = None) -> Tuple[str, int]:
    ...
    def create_prompt(self, result: LLMRerankerResult, rank_start: int, rank_end: int) -> Tuple[str, int]:
        query = result.query
